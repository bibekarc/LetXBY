...
export default function ChatSection() {
  ...
  return (
    <div className="common-container w-full md:w-3/4 mx-auto p-4 flex ">
      <div className="chat-container relative w-full md:w-11/12 rounded-xl overflow-hidden border border-dark-4">
      <Link to={`/community`} className="relative z-50">
        ...
        <div className="flex flex-col h-full relative z-10">
          ...
          <div className="flex-1 p-4 overflow-y-auto scrollbar-hide" style={{ maxHeight: 'calc(100vh - 220px)' }}>
